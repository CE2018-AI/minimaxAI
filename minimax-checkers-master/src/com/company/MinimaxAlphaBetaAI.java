...
public class MinimaxAlphaBetaAI extends Player implements AI{
    ...
    public MinimaxAlphaBetaAI(String name, Side s)
    {
        super(name, s);
    }
    public MinimaxAlphaBetaAI(Side s, int depth)
    {
        super("MinimaxAlphaBetaAI", s);
        this.depth = depth;
